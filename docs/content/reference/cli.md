...
```
earthsearch <command> [arguments] [flags]
```

Run `earthsearch <command> --help` for the full flag list on any command. This
...
per operation you declare in `earthsearch/domain.go`.
