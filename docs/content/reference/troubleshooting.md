...
Most of these come down to network reality or how earthsearch serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

earthsearch rate-limits like any public site. earthsearch already paces
...
Where a surface is gated, earthsearch reads a cookie or token you supply
...
`earthsearch`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what earthsearch actually did
