...
// HTTP behaviour is covered in earthsearch_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "earthsearch://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("earthsearch", "about")
	if err != nil || got.String() != "earthsearch://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want earthsearch://page/about", got.String(), err)
	}
}
